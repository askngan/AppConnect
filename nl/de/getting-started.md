...
{{site.data.keyword.appconservicefull}} hilft Ihnen dabei, Ihre Anwendungen zu verbinden: von einfachen Interaktionen mit Auslöseraktionen bis hin zu komplexen Integrationen.  Sie können {{site.data.keyword.appconserviceshort}} zum Erstellen von ereignisgesteuerten Abläufen oder Abläufen für APIs verwenden.  Oder Sie können die Integrationslösungen, die Sie in IBM Integration Bus erstellen, hochladen und ausführen, ohne dass eine IT-Infrastruktur angefordert und gewartet werden muss.  Sie können alle Ihre Integrationen wie Integrationsserver, ereignisgesteuerte Abläufe und Abläufe für APIs an einem Ort, nämlich im {{site.data.keyword.appconserviceshort}}-Dashboard anzeigen und verwalten. 
...
1.  Wenn Sie noch keine Verbindung zu Ihrer Anwendung hergestellt haben, klicken Sie auf **Verbindung herstellen zu _Anwendung_** und geben Sie Ihre Anmeldedetails für die Anwendung ein.
    Möglicherweise müssen Sie zusätzliche Verbindungsdetails für einige Anwendungen bereitstellen. Hilfe beim Suchen der Berechtigungsnachweise für eine bestimmte Anwendung bieten Ihnen ggf. die [Verwendungshinweise für Apps ![Symbol für externen Link](../../icons/launch-glyph.svg "Symbol für externen Link")](https://developer.ibm.com/integration/docs/app-connect/how-to-guides-for-apps/).
1.  Wählen Sie eine Aktion aus, die in Ihrer zweiten Anwendung ausgelöst werden soll, indem Sie eine Anwendung einblenden und eine Aktion auswählen.
    Bei Bedarf klicken Sie auf **Mit Anwendung verbinden** und geben Ihre Anmeldedetails für die Zielanwendung ein.
1. Geben Sie die Daten ein, die Sie zwischen Ihren Anwendungen übertragen möchten.
    Sie können Quellenfeldnamen manuell hinzufügen oder durch Klicken in ein Feld und anschließendes Klicken auf das Zuordnungssymbol ![Zuordnungssymbol](/images/MappingIcon.jpg). Sie können ferner in einen Text schreiben oder eine Transformationsfunktion zum Anpassen des Quellenwerts verwenden. Weitere Informationen finden Sie in den Verwendungshinweisen für Transformationen [How to use transformations ![Symbol für externen Link](../../icons/launch-glyph.svg "Symbol für externen Link")](https://developer.ibm.com/integration/docs/app-connect/faq/#faq_transforms).
1. Optional: Sie können die Funktionsweise des Ablaufs optimieren, indem Sie die folgenden Schritte ausführen:
    ...
    * Fügen Sie Ihrem Ablauf Abrufaktionen hinzu, um Elemente abzurufen, die bestimmten Kriterien entsprechen, oder um eine angegebene Anzahl von Datensätzen abzurufen. Sie können auch Abrufaktionen hinzufügen, die die Fehlerbehandlung definieren, oder definieren, wie die abgerufenen Elemente bearbeitet werden sollen (siehe [App Connect verwenden, um Elemente aus Ihren Anwendungen abzurufen ![Symbol für externen Link](../../icons/launch-glyph.svg "Symbol für externen Link")](https://developer.ibm.com/integration/docs/app-connect/tutorials-for-ibm-app-connect/using-ibm-app-connect-retrieve-items-applications/)).
    * Fügen Sie Bedingungslogik hinzu, um abhängig von den Daten, die von Anwendungen in Ihrem Ablauf empfangen werden, unterschiedliche Aktionen auszuführen (siehe [Bedingungslogik einem Ablauf hinzufügen ![Symbol für externen Link](../../icons/launch-glyph.svg "Symbol für externen Link")](https://developer.ibm.com/integration/docs/app-connect/tutorials-for-ibm-app-connect/adding-conditional-logic-flow/)).

1. Wenn Ihr Ablauf konfiguriert ist, öffnen Sie das Auswahlmenü in der Titelleiste und klicken Sie auf **Ablauf starten**.

Wenn Sie zum {{site.data.keyword.appconserviceshort}}-Dashboard zurückkehren, können Sie sehen, dass Ihr Ablauf ausgeführt wird.  Wenn ein Ereignis in der ersten Anwendung auftritt, wird von {{site.data.keyword.appconserviceshort}} automatisch eine Aktion in der zweiten Anwendung ausgelöst. Sie können den Status Ihrer Abläufe im {{site.data.keyword.appconserviceshort}}-Dashboard ansehen.  Wenn Sie Protokolle für Ihre Abläufe anzeigen möchten, öffnen Sie das Hamburger-Menü ![Symbol 'Hamburger-Menü'](/images/HamburgerMenuSm.jpg), blenden **Verwalten** ein und klicken dann auf **Protokolle**.
...
Wenn Sie möchten, dass ein Entwickler eine Anwendung erstellen kann, die die Daten in Ihren cloudbasierten Anwendungen verwendet, können Sie eine API bereitstellen. Führen Sie die folgenden Schritte aus, um Abläufe für eine API zu erstellen.
...
1. Geben Sie einen Namen für Ihr Modell ein, mit dem der Objekttyp, mit dem Ihre API arbeitet, widergespiegelt wird, und klicken Sie dann auf **Modell erstellen**.
1. Fügen Sie die für die Definition der Objektstruktur erforderlichen Eigenschaften für das Objekt hinzu, mit dem Ihre API arbeitet.
    Wenn Ihre API beispielsweise einen Kunden erstellt oder abruft, können Sie Eigenschaften wie 'Customer_ID', 'First_Name', 'Last_Name' und 'Email_Address' hinzufügen. Sie können entweder den Namen einer Eigenschaft eingeben oder auf **Eigenschaften aus Anwendungen auswählen** klicken, um Eigenschaften aus einer oder mehreren der Anwendungen auszuwählen, mit denen Sie verbunden sind.
1. Klicken Sie auf **Operationen**, um zu definieren, wie die API mit dem Objekt interagiert, und fügen Sie die benötigten Operationen hinzu. 
...
## IBM Integration Bus-Integrationslösung ausführen

Sie können in IBM Integration Bus oder App Connect Enterprise entwickelte Integrationslösungen in der Cloud bereitstellen, ohne eine IT-Infrastruktur anfordern und warten zu müssen. Importieren Sie eine BAR-Datei, die alle Artefakte enthält, aus denen Ihre Integrationslösung besteht, und führen Sie dann den Inhalt in einem Integrationsserver in App Connect aus. Zum Hochladen einer BAR-Datei in App Connect benötigen Sie IBM Integration Bus Version 10.0.0.4 oder höher oder App Connect Enterprise, lokal installiert.
...
1. Optional: Um die Nachrichtenflussverarbeitung zwischen Ihrer lokalen Umgebung und App Connect aufzuteilen, konfigurieren Sie aufrufbare Abläufe. Öffnen Sie das Hamburgermenü ![Symbol für Hamburger-Menü](/images/HamburgerMenuSm.jpg), blenden Sie **Verwalten** ein und wählen Sie **Aufrufbare Abläufe** aus (siehe  [Gemeinsame Nachrichtenflussverarbeitung von App Connect und Integration Bus ![Symbol für externen Link](../../icons/launch-glyph.svg "Symbol für externen Link")](https://developer.ibm.com/integration/docs/app-connect/tutorials-for-ibm-app-connect/running-your-ibm-integration-bus-solutions-in-ibm-app-connect-enterprise-beta-plan/sharing-message-flow-processing-between-app-connect-and-integration-bus-app-connect-enterprise-beta)).
1. Wenn die Konfiguration abgeschlossen ist, kehren Sie zum App Connect-Dashboard zurück und starten Sie den Integrationsserver, indem Sie das Kachelmenü öffnen und auf **Starten** klicken.
...
Weitere Informationen finden Sie unter [Ihre Integration Bus-Lösungen in App Connect ausführen ![Symbol für externen Link](../../icons/launch-glyph.svg "Symbol für externen Link")](https://developer.ibm.com/integration/docs/app-connect/tutorials-for-ibm-app-connect/running-your-ibm-integration-bus-solutions-in-ibm-app-connect-enterprise-beta-plan).
