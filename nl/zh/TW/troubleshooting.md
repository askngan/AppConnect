...
-   若為服務及開始使用指示的相關問題，請使用 [IBM developerWorks&reg; dW Answers ![外部鏈結圖示](../../icons/launch-glyph.svg "外部鏈結圖示")](https://developer.ibm.com/answers/topics/app_connect/?smartspace=bluemix) 討論區。請包含標籤 "ibm_cloud" 及 "app_connect"（含底線）。
